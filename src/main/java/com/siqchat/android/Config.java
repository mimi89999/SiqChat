...
public final class Config {
	...
	public static final String LOGTAG = "SiqChat";

	public static final String BUG_REPORTS = "bugs@siqchat.tk";


	public static final String DOMAIN_LOCK = "siqchat.tk"; //only allow account creation for this domain
	public static final String CONFERENCE_DOMAIN_LOCK = "chat.siqchat.tk";
	public static final boolean LOCK_DOMAINS_IN_CONVERSATIONS = true;
	public static final String MAGIC_CREATE_DOMAIN = "siqchat.tk";
