...
import com.siqchat.android.crypto.PgpDecryptionService;
import com.siqchat.android.crypto.PgpEngine;
import com.siqchat.android.crypto.axolotl.AxolotlService;
import com.siqchat.android.crypto.axolotl.XmppAxolotlMessage;
import com.siqchat.android.entities.Account;
import com.siqchat.android.entities.Blockable;
import com.siqchat.android.entities.Bookmark;
import com.siqchat.android.entities.Contact;
import com.siqchat.android.entities.Conversation;
import com.siqchat.android.entities.Message;
import com.siqchat.android.entities.MucOptions;
import com.siqchat.android.entities.MucOptions.OnRenameListener;
import com.siqchat.android.entities.Presence;
import com.siqchat.android.entities.PresenceTemplate;
import com.siqchat.android.entities.Roster;
import com.siqchat.android.entities.ServiceDiscoveryResult;
import com.siqchat.android.entities.Transferable;
import com.siqchat.android.entities.TransferablePlaceholder;
import com.siqchat.android.generator.AbstractGenerator;
import com.siqchat.android.generator.IqGenerator;
import com.siqchat.android.generator.MessageGenerator;
import com.siqchat.android.generator.PresenceGenerator;
import com.siqchat.android.http.HttpConnectionManager;
import com.siqchat.android.parser.AbstractParser;
import com.siqchat.android.parser.IqParser;
import com.siqchat.android.parser.MessageParser;
import com.siqchat.android.parser.PresenceParser;
import com.siqchat.android.persistance.DatabaseBackend;
import com.siqchat.android.persistance.FileBackend;
import com.siqchat.android.ui.UiCallback;
import com.siqchat.android.utils.CryptoHelper;
import com.siqchat.android.utils.ExceptionHelper;
import com.siqchat.android.utils.OnPhoneContactsLoadedListener;
import com.siqchat.android.utils.PRNGFixes;
import com.siqchat.android.utils.PhoneHelper;
import com.siqchat.android.utils.ReplacingSerialSingleThreadExecutor;
import com.siqchat.android.utils.SerialSingleThreadExecutor;
import com.siqchat.android.utils.Xmlns;
import com.siqchat.android.xml.Element;
import com.siqchat.android.xmpp.OnBindListener;
import com.siqchat.android.xmpp.OnContactStatusChanged;
import com.siqchat.android.xmpp.OnIqPacketReceived;
import com.siqchat.android.xmpp.OnKeyStatusUpdated;
import com.siqchat.android.xmpp.OnMessageAcknowledged;
import com.siqchat.android.xmpp.OnMessagePacketReceived;
import com.siqchat.android.xmpp.OnPresencePacketReceived;
import com.siqchat.android.xmpp.OnStatusChanged;
import com.siqchat.android.xmpp.OnUpdateBlocklist;
import com.siqchat.android.xmpp.XmppConnection;
import com.siqchat.android.xmpp.chatstate.ChatState;
import com.siqchat.android.xmpp.forms.Data;
import com.siqchat.android.xmpp.forms.Field;
import com.siqchat.android.xmpp.jid.InvalidJidException;
import com.siqchat.android.xmpp.jid.Jid;
import com.siqchat.android.xmpp.jingle.JingleConnectionManager;
import com.siqchat.android.xmpp.jingle.OnJinglePacketReceived;
import com.siqchat.android.xmpp.jingle.stanzas.JinglePacket;
import com.siqchat.android.xmpp.pep.Avatar;
