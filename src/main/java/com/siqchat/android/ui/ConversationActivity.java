...
import com.siqchat.android.crypto.axolotl.XmppAxolotlSession;
...
import com.siqchat.android.services.XmppConnectionService.OnAccountUpdate;
import com.siqchat.android.services.XmppConnectionService.OnConversationUpdate;
import com.siqchat.android.services.XmppConnectionService.OnRosterUpdate;
import com.siqchat.android.ui.adapter.ConversationAdapter;
...
public class ConversationActivity extends XmppActivity
	...
	public static final String ACTION_DOWNLOAD = "com.siqchat.android.action.DOWNLOAD";
			...
			public void onPresenceSelected() {
				...
				switch (attachmentChoice) {
					...
					case ATTACHMENT_CHOICE_RECORD_VOICE:
						...
						fallbackPackageId = "com.siqchat.android.voicerecorder";
						break;
					case ATTACHMENT_CHOICE_LOCATION:
						intent.setAction("com.siqchat.android.location.request");
						fallbackPackageId = "com.siqchat.android.sharelocation";
						break;
				}
	...
	protected void attachFileDialog() {
		...
		if (new Intent("com.siqchat.android.location.request").resolveActivity(getPackageManager()) == null) {
