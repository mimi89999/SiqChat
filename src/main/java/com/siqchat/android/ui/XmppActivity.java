...
import com.siqchat.android.entities.Presences;
import com.siqchat.android.services.AvatarService;
import com.siqchat.android.services.XmppConnectionService;
import com.siqchat.android.services.XmppConnectionService.XmppConnectionBinder;
import com.siqchat.android.ui.widget.Switch;
			...
			nfcAdapter.setNdefPushMessageCallback(new NfcAdapter.CreateNdefMessageCallback() {
				...
				public NdefMessage createNdefMessage(NfcEvent nfcEvent) {
					return new NdefMessage(new NdefRecord[]{
							...
							NdefRecord.createApplicationRecord("com.siqchat.android")
					});
				}
			}, this);
		}
